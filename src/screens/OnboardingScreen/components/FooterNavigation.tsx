  ...
  return (
    <View style={tw`flex-row justify-between`}>
      <Pressable onPress={onSkipPress} style={tw`opacity-50`}>
        <Text variant={TextVariant.Title1} color={Color.Neutral.White}>
          Skip{' '}
        </Text>
      </Pressable>
      <View style={tw`flex-row justify-between items-center gap-2`}>
        <View
          style={tw`h-2 w-2 rounded-full bg-[${
            currentStep === 0 ? Color.Neutral.White : Color.Neutral.EH100
          }]`}
        />
        <View
          style={tw`h-2 w-2 rounded-full bg-[${
            currentStep === 1 ? Color.Neutral.White : Color.Neutral.EH100
          }]`}
        />
        <View
          style={tw`h-2 w-2 rounded-full bg-[${
            currentStep === 2 ? Color.Neutral.White : Color.Neutral.EH100
          }]`}
        />
      </View>
